$(function() {
    ...
    $(document).ready(function() { // quando a página carregar...
        ...
        jQuery.fn.extend({  //modificação no jquery para melhor dinâmica nas cores, precisa ler isso não
            getPseudo: function(pseudo, prop) {
              var props = window.get(
        ...
        function adaptColor(){ //função para adaptação de cores
            ...
            if(coords > 0) {
                ...
                $('header .container ul.mobile li a').css({'color': 'rgb(221,221,221)'})
                $('header .container ul.desktop li').setPseudo('::before', 'background', 'rgb(4,4,4)')
                ...
                $('body.dark header .container ul.mobile li:before').css({'background': 'rgb(221,221,221)'})
            }else{
